...
function iti_widget_image_return(iti_widget_image_id,iti_widget_image_thumb){
    ...
    iti_widget_image_context.parents('.iti-image-widget-field').find( '.remove-image' ).show();
}
...
jQuery(document).ready(function(){
    ...
    jQuery('.iti-image-widget-field a.remove-image').live( 'click', function() {
	 	var $field = jQuery( this ).parents( '.iti-image-widget-field' );
